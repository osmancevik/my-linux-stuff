...
plugins=(git archlinux sudo command-not-found zsh-syntax-highlighting zsh-autosuggestions colored-man-pages extract)
...
alias ls='lsd'
alias l='lsd -l'           # Detaylı liste (izinler, boyut, tarih)
alias la='lsd -a'          # Gizli dosyaları göster
alias ll='lsd -la'         # Her şeyi gösteren detaylı liste
alias lt='lsd --tree'      # Klasör yapısını ağaç olarak göster
